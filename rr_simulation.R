...
png("rrplot.png", width = 800, height = 400)
...
ggplot(data=as.data.frame(sor), aes(x = time, y=pA1P, group=1, color="P" )) +
    ...
    geom_vline(xintercept = 80, linetype = "dashed", colour = 'grey') + 
    geom_vline(xintercept = 110, linetype = "dashed", colour = 'grey') +

...
sor2[input$sorQon1[1]:input$sorQon1[2],'p1Q'] = input$sor2Qp1
sor2[input$sorXon1[1]:input$sorXon1[2],'p1X'] = input$sor2Xp1
...
ggplot(data=pv, aes(x = time, y=Vh, color="Vph")) +
    geom_line(size = 1) +
    geom_line(aes(y=Vl, colour = 'Vpl'), size = 1) +
    theme_classic() + 
